...
def run_medical_agent(query: str, classification: ClassificationOutput, settings: Settings) -> AgentResponse:
    try:
        ...
        messages = [
            {"role": "system", "content": "You are a medical information assistant. Provide educational, high-level information only. Do NOT diagnose, prescribe, or provide dosages. Encourage professional medical help when appropriate. Be concise and clear."},
        ...
        # Generic fallback
        fallback = f"I can provide general educational information about medical topics. For specific health concerns, including symptoms, diagnosis, or treatment, please consult with a qualified healthcare professional who can evaluate your individual situation. Every person's health needs are unique and require personalized medical assessment."
        return AgentResponse(
            content=fallback,
            disclaimers=[MEDICAL_DISCLAIMER],
            safety_notes=[],
